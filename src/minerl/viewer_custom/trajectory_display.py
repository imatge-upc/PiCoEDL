...
class TrajectoryDisplayBase(ScaledImageDisplay):
    ...
    def make_instructions(self, environment, stream_name):
        ...
        self.instructions_labels = [
            pyglet.text.Label('Validation trajectories', font_size=BIG_FONT_SIZE, y = self.height-SZ, x = SZ/2, anchor_x='left'),
    ...
    def make_coords_plotter(self, step):
        ...
        self.coords_label = pyglet.text.Label(
            'X,Z Coordinates', font_size=SMALLER_FONT_SIZE, x=100, y=190,
